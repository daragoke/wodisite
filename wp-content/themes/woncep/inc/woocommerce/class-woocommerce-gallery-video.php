<?php
/**
 * Woncep WooCommerce Gallery Video Class
 *
 * @package  woncep
 * @since    2.4.3
 */
...
if (!class_exists('Woncep_WooCommerce_Video')) :

    /**
     * The Woncep WooCommerce Gallery Video Class
     */
    class Woncep_WooCommerce_Video {
        ...
        public function video_product_tabs($tabs) {
            ...
            $tabs['video'] = array(
                'label'    => esc_html__('Product Video', 'woncep'),
            ...
            <div id='video_options' class='panel woocommerce_options_panel'><?php
                ...
                <div class='options_group'><?php
                    ...
                    woocommerce_wp_text_input(array(
                        'id'    => '_video_select',
                        'label' => esc_html__('Url Video', 'woncep'),
                    ));
                    ...
                    <p class="form-field _video_thumbnail_field ">
                        <label for="_video_thumbnail"><?php echo esc_html__('Video Thumbnail', 'woncep'); ?></label>
                        <a href="#" class="video_thumbnail_button"><img height="100" width="100" src="<?php echo esc_attr($video_thumbnail); ?>" alt="video thumbnail"></a>
    ...
    return new Woncep_WooCommerce_Video();
