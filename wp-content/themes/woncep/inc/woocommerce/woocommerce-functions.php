 ...
 * @return boolean
 */
function woncep_is_product_archive() {
 ...
 */
function woncep_product_get_image($product){
 ...
 * @param $product WC_Product
 */
function woncep_product_get_price_html($product){
 ...
 *
 */
function woncep_get_previous_product($in_same_term = false, $excluded_terms = '', $taxonomy = 'product_cat') {
    $product = new Woncep_WooCommerce_Adjacent_Products($in_same_term, $excluded_terms, $taxonomy, true);
 ...
 *
 */
function woncep_get_next_product($in_same_term = false, $excluded_terms = '', $taxonomy = 'product_cat') {
    $product = new Woncep_WooCommerce_Adjacent_Products($in_same_term, $excluded_terms, $taxonomy);
    return $product->get_product();
}


function woncep_is_woocommerce_extension_activated($extension = 'WC_Bookings') {
...
function osf_woocommerce_pagination_args($args) {
    $args['prev_text'] = '<span>' . esc_html__('PREVIOUS', 'woncep').'</span>';
    $args['next_text'] ='<span>'. esc_html__('NEXT', 'woncep') . '</span>';
    return $args;
}
 ...
 * @return bool
 */
function woncep_woocommerce_is_deal_product($product)
{
