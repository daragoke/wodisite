...
if (!class_exists('OTF_Dokan')) :
    class OTF_Dokan {
        ...
        public function __construct() {
            ...
            add_filter('woncep_customizer_buttons', array($this, 'customizer_buttons'));
        ...
        public function store_list_config_default($atts) {
            $atts['per_page'] = get_theme_mod('woncep_dokan_store_list_vendor_number', 10);
            $atts['per_row']  = get_theme_mod('woncep_dokan_store_list_vendor_columns', 3);
            return $atts;
        }
        ...
        public function dokan_scripts() {
            ...
            wp_enqueue_style('woncep-dokan-style', get_template_directory_uri() . '/assets/css/dokan/dokan.css', array(), $woncep_version);
            wp_style_add_data('woncep-dokan-style', 'rtl', 'replace');
