...
class OSF_Elementor_Post_Grid extends Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'woncep-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'woncep');
    }
    ...
    public function get_script_depends() {
        return ['woncep-elementor-posts-grid', 'slick'];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'woncep'),
                    'post_title' => esc_html__('Title', 'woncep'),
        ...
        $this->add_control(
            'layout',
            [
                'label' => esc_html__('Layout', 'woncep'),
                'type'  => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => esc_html__('Pagination', 'woncep'),
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'options' => [
                    ''                      => esc_html__('None', 'woncep'),
                    'numbers'               => esc_html__('Numbers', 'woncep'),
                    'prev_next'             => esc_html__('Previous/Next', 'woncep'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'woncep') . ' + ' . esc_html__('Previous/Next', 'woncep'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'woncep'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'woncep'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'woncep'),
                'default'   => esc_html__('&laquo; Previous', 'woncep'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'woncep'),
                'default'   => esc_html__('Next &raquo;', 'woncep'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'woncep') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation"
                 aria-label="<?php esc_attr_e('Pagination', 'woncep'); ?>">
