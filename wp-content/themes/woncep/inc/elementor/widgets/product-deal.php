 ...
 * @since 1.0.0
 */
class Woncep_Elementor_Widget_Products_Deals extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Products Deal Of The Day', 'woncep');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'title',
            [
                'label' => esc_html__('Element Title', 'woncep'),
    ...
    protected function render() {
        ...
        $date_form = woncep_get_theme_option('wocommerce_product_deal_time_form');
        $date      = woncep_get_theme_option('wocommerce_product_deal_time_to');
        $data_date = 0;
        if ($date && $date_form) {
            ...
            <div class="fieldset">
                <div class="legend">
                    <div class="legend-wrap">
                        <div class="element-deal-title"><?php printf('%s', $settings['title']); ?></div>
                        <div class="deal-time">
                            <i class="woncep-icon woncep-icon-clock"></i>
                        ...
                        <ul class="products">
                            <?php while ($wp_query->have_posts()) : $wp_query->the_post();
                                ...
                                <li <?php wc_product_class('', $product); ?>>
                                    ...
                                    woncep_woocommerce_deal_progress();
...
$widgets_manager->register_widget_type(new Woncep_Elementor_Widget_Products_Deals());
