 ...
 * @since 1.0.0
 */
class Woncep_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Brands', 'woncep');
    }
    ...
    public function get_script_depends() {
        return ['woncep-elementor-brand', 'slick'];
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'woncep'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'woncep'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'woncep'),
                'placeholder' => esc_html__('Brand Name', 'woncep'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'type_brand',
            [
                'label'   => esc_html__('Type', 'woncep'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image', 'woncep'),
                    'icon'  => esc_html__('Icon & SVG', 'woncep'),
                ],
                'default' => 'image',
            ]
        );
        ...
        $this->start_controls_section(
            'style_brand_icon',
            [
                'label' => esc_html__('Icon & SVG', 'woncep'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'icon_color_hover',
            [
                'label'     => esc_html__('Primary Color', 'woncep'),
                'type'      => Controls_Manager::COLOR,
                'global' => [
                        ...
                        <div <?php echo woncep_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . woncep_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
                                ...
                                if ($item['type_brand'] == 'image') {
                                    ...
                                    if ($is_new || $migrated) {
                                        ...
                                        <i <?php echo woncep_elementor_get_render_attribute_string('icon', $this); // WPCS: XSS ok. ?>></i>
                                        <?php
                                    }
                                }
                                if (!empty($item['link'])) {
...
$widgets_manager->register_widget_type(new Woncep_Elementor_Brand());
