...
/**
 * Elementor Woncep_Elementor_Products_Categories
 * @since 1.0.0
 */
class Woncep_Elementor_Products_Categories extends Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'woncep-product-categories';
    }
    ...
    public function get_title() {
        return esc_html__('Product Categories', 'woncep');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'categories_name',
            [
                'label' => esc_html__('Alternate Name', 'woncep'),
	    ...
	    $this->add_responsive_control(
		    'image_height',
		    [
			    'label'      => esc_html__('Min Height', 'woncep'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Background Hover', 'woncep'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
    ...
    protected function render() {
        ...
        if (empty($settings['categories'])) {
            echo esc_html__('Choose Category', 'woncep');
            return;
        }
        ...
        if (!is_wp_error($category)) {
            ...
            <div class="product-cat">
                <?php if ($settings['categories_style'] == '1'): ?>
                    ...
                    <div class="cat-total"><?php echo esc_html($category->count) . ' ' . esc_html__('Products', 'woncep'); ?></div>
                <?php elseif ($settings['categories_style'] == '2' || $settings['categories_style'] == '4' || $settings['categories_style'] == '5'): ?>
                    <div class="cat-image">
                        ...
                        <div class="product-cat-caption">
                            <div class="cat-title">
                                <a href="<?php echo esc_url(get_term_link($category)); ?>" title="<?php echo esc_attr($category->name); ?>">
                                    <span class="cats-title-text"><?php echo empty($settings['categories_name']) ? esc_html($category->name) : esc_html($settings['categories_name']); ?></span>
                                </a>
                            </div>
                            <div class="cat-total"><?php echo esc_html($category->count) . ' ' . esc_html__('Items', 'woncep'); ?></div>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="cat-image">
...
$widgets_manager->register_widget_type(new Woncep_Elementor_Products_Categories());
